...
switch ($_POST['function']) {
    ...
    case 'martfury-session':
        die(sb_json_response(sb_martfury_save_session()));
    case 'martfury-get-conversation-details':
        die(sb_json_response(sb_martfury_get_conversation_details($_POST['user_id'], $_POST['martfury_id'])));
    case 'martfury-sync':
    case 'martfury-sync-sellers':
        die(sb_json_response(sb_martfury_import_users($_POST['function'] == 'martfury-sync-sellers')));
    default:
